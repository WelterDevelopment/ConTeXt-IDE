...
namespace ConTeXt_UWP
{
    public class Settings : Bindable
    {
        ...
        public string ShowLineNumbers { get => Get("on"); set { Set(value); if (App.VM.EditorOptions != null) App.VM.EditorOptions.LineNumbers = value; } }
        ...
        public string Theme { get => Get("Default"); set => Set(value); }
        public string TexFileName { get => Get(""); set => Set(value); }
        public string Modes { get => Get(""); set => Set(value); }
        public bool CodeFolding { get => Get(true); set { Set(value); if (App.VM.EditorOptions != null) App.VM.EditorOptions.Folding = value; } }
        public bool MiniMap { get => Get(true); set { Set(value); if (App.VM.EditorOptions != null) App.VM.EditorOptions.Minimap = new EditorMinimapOptions() { Enabled = value, ShowSlider = "always", RenderCharacters = true }; ; } }
        public bool Hover { get => Get(true); set { Set(value); if (App.VM.EditorOptions != null) App.VM.EditorOptions.Hover = new EditorHoverOptions() { Enabled = value, Delay = 100, Sticky = true }; } }
        ...
        public List<string> ShowLineNumberOptions
        {
            get
            {
                return new List<string>() { "on", "off", "interval", "relative" };
            }
        }
        ...
        public string[] ThemeOption
        {
            get
            {
                return new string[] { "Default", "Light", "Dark" };
            }
        }
    }
